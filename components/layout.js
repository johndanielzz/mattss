...
const navItems = [
  ...
  { href: "/campaigns.html", label: "Campaigns", icon: "E" },
  { href: "/marketplace.html", label: "Marketplace", icon: "$" },
  { href: "/reports.html", label: "Reports", icon: "R" },
  { href: "/analytics.html", label: "Analytics", icon: "A" },
  { href: "/pricing.html", label: "Pricing", icon: "P" },
  { href: "/profile.html", label: "Profile", icon: "U" },
